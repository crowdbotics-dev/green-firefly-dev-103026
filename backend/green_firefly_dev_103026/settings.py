"""
Django settings for green_firefly_dev_103026 project.
...
ROOT_URLCONF = 'green_firefly_dev_103026.urls'
...
WSGI_APPLICATION = 'green_firefly_dev_103026.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_firefly_dev_103026 API",
    "DESCRIPTION": "API documentation for green_firefly_dev_103026 App",
    "VERSION": "v1",
}
